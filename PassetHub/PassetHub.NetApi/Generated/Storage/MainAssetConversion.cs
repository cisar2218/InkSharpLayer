...
namespace PassetHub.NetApi.Generated.Storage
{
    ...
    public sealed class AssetConversionStorage
    {
        ...
        /// </summary>
        public static string PoolsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location, PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location> key)
        {
        ...
        ///  created rather than people sending tokens directly to a pool's public account.
        /// </summary>
        public async Task<PassetHub.NetApi.Generated.Model.pallet_asset_conversion.types.PoolInfo> Pools(Substrate.NetApi.Model.Types.Base.BaseTuple<PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location, PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location> key, string blockhash, CancellationToken token)
        {
            string parameters = AssetConversionStorage.PoolsParams(key);
            var result = await _client.GetStorageAsync<PassetHub.NetApi.Generated.Model.pallet_asset_conversion.types.PoolInfo>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class AssetConversionCalls
    {
        ...
        /// </summary>
        public static Method CreatePool(PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location asset1, PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location asset2)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset1.Encode());
            byteArray.AddRange(asset2.Encode());
            return new Method(56, "AssetConversion", 0, "create_pool", byteArray.ToArray());
        }
        ...
        public static Method AddLiquidity(PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location asset1, PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location asset2, Substrate.NetApi.Model.Types.Primitive.U128 amount1_desired, Substrate.NetApi.Model.Types.Primitive.U128 amount2_desired, Substrate.NetApi.Model.Types.Primitive.U128 amount1_min, Substrate.NetApi.Model.Types.Primitive.U128 amount2_min, PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 mint_to)
        {
            ...
            return new Method(56, "AssetConversion", 1, "add_liquidity", byteArray.ToArray());
        }
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method RemoveLiquidity(PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location asset1, PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location asset2, Substrate.NetApi.Model.Types.Primitive.U128 lp_token_burn, Substrate.NetApi.Model.Types.Primitive.U128 amount1_min_receive, Substrate.NetApi.Model.Types.Primitive.U128 amount2_min_receive, PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 withdraw_to)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset1.Encode());
            byteArray.AddRange(asset2.Encode());
            ...
            return new Method(56, "AssetConversion", 2, "remove_liquidity", byteArray.ToArray());
        }
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method SwapExactTokensForTokens(Substrate.NetApi.Model.Types.Base.BaseVec<PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location> path, Substrate.NetApi.Model.Types.Primitive.U128 amount_in, Substrate.NetApi.Model.Types.Primitive.U128 amount_out_min, PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 send_to, Substrate.NetApi.Model.Types.Primitive.Bool keep_alive)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            ...
            return new Method(56, "AssetConversion", 3, "swap_exact_tokens_for_tokens", byteArray.ToArray());
        }
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method SwapTokensForExactTokens(Substrate.NetApi.Model.Types.Base.BaseVec<PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location> path, Substrate.NetApi.Model.Types.Primitive.U128 amount_out, Substrate.NetApi.Model.Types.Primitive.U128 amount_in_max, PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 send_to, Substrate.NetApi.Model.Types.Primitive.Bool keep_alive)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(path.Encode());
            ...
            byteArray.AddRange(send_to.Encode());
            byteArray.AddRange(keep_alive.Encode());
            return new Method(56, "AssetConversion", 4, "swap_tokens_for_exact_tokens", byteArray.ToArray());
        }
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method Touch(PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location asset1, PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location asset2)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset1.Encode());
            byteArray.AddRange(asset2.Encode());
            return new Method(56, "AssetConversion", 5, "touch", byteArray.ToArray());
        }
    }
    ...
    public sealed class AssetConversionConstants
    {
        ...
        /// </summary>
        public PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location PoolSetupFeeAsset()
        {
            var result = new PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location();
        ...
        /// </summary>
        public PassetHub.NetApi.Generated.Model.sp_arithmetic.per_things.Permill LiquidityWithdrawalFee()
        {
            var result = new PassetHub.NetApi.Generated.Model.sp_arithmetic.per_things.Permill();
