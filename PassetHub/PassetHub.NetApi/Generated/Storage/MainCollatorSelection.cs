...
namespace PassetHub.NetApi.Generated.Storage
{
    ...
    public sealed class CollatorSelectionStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "Invulnerables"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(PassetHub.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "CandidateList"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(PassetHub.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "LastAuthoredBlock"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
        ...
        ///  The invulnerable, permissioned collators. This list must be sorted.
        /// </summary>
        public async Task<PassetHub.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14> Invulnerables(string blockhash, CancellationToken token)
        {
            string parameters = CollatorSelectionStorage.InvulnerablesParams();
            var result = await _client.GetStorageAsync<PassetHub.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  recently updated is considered greater.
        /// </summary>
        public async Task<PassetHub.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15> CandidateList(string blockhash, CancellationToken token)
        {
            string parameters = CollatorSelectionStorage.CandidateListParams();
            var result = await _client.GetStorageAsync<PassetHub.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string LastAuthoredBlockParams(PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Last block authored by collator.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> LastAuthoredBlock(PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class CollatorSelectionCalls
    {
        ...
        /// </summary>
        public static Method SetInvulnerables(Substrate.NetApi.Model.Types.Base.BaseVec<PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32> @new)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddInvulnerable(PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveInvulnerable(PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(who.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method TakeCandidateSlot(Substrate.NetApi.Model.Types.Primitive.U128 deposit, PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
    ...
    public sealed class CollatorSelectionConstants
    {
        ...
        /// </summary>
        public PassetHub.NetApi.Generated.Model.frame_support.PalletId PotId()
        {
        ...
        /// </summary>
        public PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 pot_account()
        {
            var result = new PassetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32();
