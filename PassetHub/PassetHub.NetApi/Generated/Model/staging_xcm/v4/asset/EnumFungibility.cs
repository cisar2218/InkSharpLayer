...
namespace PassetHub.NetApi.Generated.Model.staging_xcm.v4.asset
{
    ...
    /// <summary>
    /// >> 141 - Variant[staging_xcm.v4.asset.Fungibility]
    /// </summary>
    public sealed class EnumFungibility : BaseEnumRust<Fungibility>
    {
        ...
        public EnumFungibility()
        {
				...
				AddTypeDecoder<PassetHub.NetApi.Generated.Model.staging_xcm.v4.asset.EnumAssetInstance>(Fungibility.NonFungible);
        }
    }
}
