...
namespace PassetHub.NetApi.Generated.Model.staging_xcm.v5.asset
{
    ...
    /// <summary>
    /// >> 81 - Variant[staging_xcm.v5.asset.Fungibility]
    /// </summary>
    public sealed class EnumFungibility : BaseEnumRust<Fungibility>
    {
        ...
        public EnumFungibility()
        {
				...
				AddTypeDecoder<PassetHub.NetApi.Generated.Model.staging_xcm.v5.asset.EnumAssetInstance>(Fungibility.NonFungible);
        }
    }
}
