...
namespace PassetHub.NetApi.Generated.Model.staging_xcm.v5
{
    ...
    /// <summary>
    /// >> 98 - Composite[staging_xcm.v5.QueryResponseInfo]
    /// </summary>
    ...
    public sealed class QueryResponseInfo : BaseType
    {
        ...
        /// >> destination
        /// </summary>
        public PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location Destination { get; set; }
        /// <summary>
        /// >> query_id
        /// </summary>
        ...
        {
            var start = p;
            Destination = new PassetHub.NetApi.Generated.Model.staging_xcm.v5.location.Location();
