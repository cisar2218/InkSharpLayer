...
namespace PassetHub.NetApi.Generated.Model.pallet_revive.storage
{
    ...
    /// <summary>
    /// >> 553 - Composite[pallet_revive.storage.ContractInfo]
    /// </summary>
    ...
    public sealed class ContractInfo : BaseType
    {
        ...
        /// >> trie_id
        /// </summary>
        public PassetHub.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 TrieId { get; set; }
        /// <summary>
        /// >> code_hash
        /// </summary>
        public PassetHub.NetApi.Generated.Model.primitive_types.H256 CodeHash { get; set; }
        /// <summary>
        /// >> storage_bytes
        /// </summary>
        ...
        /// >> immutable_data_len
        /// </summary>
        public Substrate.NetApi.Model.Types.Primitive.U32 ImmutableDataLen { get; set; }
        ...
        public override byte[] Encode()
        {
            ...
            result.AddRange(ImmutableDataLen.Encode());
        ...
        {
            var start = p;
            TrieId = new PassetHub.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6();
            TrieId.Decode(byteArray, ref p);
            CodeHash = new PassetHub.NetApi.Generated.Model.primitive_types.H256();
            ...
            ImmutableDataLen = new Substrate.NetApi.Model.Types.Primitive.U32();
            ImmutableDataLen.Decode(byteArray, ref p);
