...
namespace PassetHub.NetApi.Generated.Model.staging_xcm_executor.traits.asset_transfer
{
    ...
    /// <summary>
    /// >> 404 - Variant[staging_xcm_executor.traits.asset_transfer.TransferType]
    /// </summary>
    public sealed class EnumTransferType : BaseEnumRust<TransferType>
    {
        ...
        public EnumTransferType()
        {
				...
				AddTypeDecoder<PassetHub.NetApi.Generated.Model.xcm.EnumVersionedLocation>(TransferType.RemoteReserve);
        }
    }
}
