...
namespace PassetHub.NetApi.Generated.Model.cumulus_primitives_core
{
    ...
    /// <summary>
    /// >> 149 - Variant[cumulus_primitives_core.AggregateMessageOrigin]
    /// </summary>
    public sealed class EnumAggregateMessageOrigin : BaseEnumRust<AggregateMessageOrigin>
    {
        ...
        public EnumAggregateMessageOrigin()
        {
				...
				AddTypeDecoder<PassetHub.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id>(AggregateMessageOrigin.Sibling);
        }
    }
}
